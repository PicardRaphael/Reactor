...
const mapDispatchToProps = dispatch => ({
  /**
   * Callback when component GlobalMap is construct for create globalmap
   * called once
  */
  createMap: () => {
    dispatch({
  ...
  /**
   * Callback when component GlobalMap is construct for create roomStart
   * called once
  */
  generateRoomStart: () => {
    dispatch({
  ...
  /**
   * Callback when component GlobalMap is construct for create roomBoss
   * called once
  */
  generateRoomBoss: () => {
    dispatch({
  ...
  /**
   * Callback when component GlobalMap is construct for create roomChest
   * called once
  */
  generateRoomChest: () => {
    dispatch({
  ...
  /**
   * Callback when component GlobalMap is construct for create roomHostile1
   * called once
  */
  ...
  /**
   * Callback when component GlobalMap is construct for create roomHostile2
   * called once
  */
